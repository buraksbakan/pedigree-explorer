...
class ChromosomePlot(QWidget):
    ...
    def highlight_region(self, chrom, start, end):
        ...
        # Pick next colour
        fill, line = self.highlight_colors[self.highlight_index]
        self.highlight_index = (self.highlight_index + 1) % len(self.highlight_colors)
    ...
    def clear_highlights(self):
        # Reset highlight bookkeeping
        self.highlight_shapes = []
        self.highlight_index = 0

        # Rebuild the base figure (all chromosomes, no highlights)
        self.update_plot()
