#!/bin/bash
# s02_illumina_plink_family8
#
# Cameron Brown 20Mar2026

# Crescent2 script
# Note: this script should be run on a compute node
# qsub s02_illumina_plink_family8

# PBS directives
#---------------

#PBS -N s02_illumina_plink_family8
...
input_vcf="${base_folder}/data/processed/illumina/clean/family_8/illumina.family8.clean.vcf.gz"
output_folder="${base_folder}/data/processed/illumina/plink/family_8/"
output_prefix="${output_folder}/illumina_clean_family8"
