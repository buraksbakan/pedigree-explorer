...
input_vcf="${base_folder}/family_8/illumina/IHCAPX8_dragen_joint.hard-filtered.vcf.gz"
output_folder="${base_folder}/data/processed/illumina/clean/family_8/"

output_vcf="${output_folder}/illumina.family8.clean.vcf.gz"
