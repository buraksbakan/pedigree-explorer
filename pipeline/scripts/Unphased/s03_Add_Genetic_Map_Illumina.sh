#!/bin/bash
# s03_Add_Genetic_Map_3_Split
#
# Cameron Brown 24Mar2026

# Crescent2 script
# Note: this script should be run on a compute node
# qsub s03_Add_Genetic_Map_3_Split

# PBS directives
#---------------

#PBS -N s03_Add_Genetic_Map_3_Split
...
pipeline_folder="${base_folder}/data/processed/Illumina_Preprocessing_3_Split"
...
# Prefixes
input_prefix="${plink_files_folder}/illumina_clean_3_Split"
output_prefix="${mapped_plink_folder}/illumina_clean_3_Split_mapped"

raw_mapped_vcf_prefix="${mapped_plink_vcf_folder}/illumina_clean_3_Split_mapped_raw"
raw_mapped_vcf="${raw_mapped_vcf_prefix}.vcf.gz"

sorted_mapped_vcf_prefix="${mapped_plink_vcf_folder}/illumina_clean_3_Split_mapped"
